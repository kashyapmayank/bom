			...
			try{
				...
				xhttp.onreadystatechange = function() {
					if (this.readyState == 4 && this.status == 200) {
						...
						document.getElementById("drugs").innerHTML = this.responseText;
						...
						var table2_Props = {
							...
							//rows_counter: true,
							col_operation: {
								id: ["table8Tot1", "table8Tot2","table8Tot3","table8Tot4"],
								col: [7,8,9,10],
...
<nav class="navbar navbar-expand-sm navbar-light bg-light justify-content-between">
        <a class="navbar-brand" href="#"><b>Drug Report Invoice<?php echo "(".$_SESSION['adminusername'].")";?></b></a>
        ...
        <div class="collapse navbar-collapse flex-grow-0" id="navbarNav">
            <ul class="navbar-nav mr-auto justify-content-left">				
				...
				<?php date_default_timezone_set('Asia/Kolkata');
					$exportFileName="InvoiceReport_".date("d-M-Y").".csv";?>
				...
				<li class="nav-item" >
                    <a class="nav-link" href="stockdata.php"><button class="btn btn-outline-success">Stockdata</button></a>
                </li>
				<li class="nav-item" >
	...
	if($pwdoldpwd==$druguser_pass_old)
    {
		if($pwdnewpwd==$pwdcnfpwd)
		{
			...
			{	
				...
				echo "<meta http-equiv='refresh' content='5;url=invoicerep.php'>";
				echo "</div>";
			}
			else 
			{
