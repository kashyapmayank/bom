...
<body>
 <nav class="navbar navbar-expand-sm navbar-light bg-light justify-content-between">
        <a class="navbar-brand" href="#"><b>Bill Of Material</b></a>
                    ...
                    <form role="form" method="post" action="index.php"  style="padding:10px;">
                        <fieldset>
                            <div class="form-group"  >
                                <input class="form-control" placeholder="Employee Code" name="druguserid" id="druguserid"  type="text" autofocus required>
                            </div>
...
<footer class="footer p-1">			
			<center><p id="CopyRight" class="mt-1 mb-1 text-muted"> © 2021&nbsp; <a href="mailto:manti_madhu@ecil.co.in">RID Software Development Team</a></p></center>
...
if(isset($_POST['login']))
{
    ...
    {			
		...
		$data=GetUserName($druguser_id);
		$_SESSION['adminusername']	=$data;
        echo "<script>window.open('bomdata.php','_self')</script>";
